...
def extract_all_units_armours(input_json_path, classes_xlsx_path, units_xlsx_path, json_output_path):
...
extract_all_units_armours(input_json_path, classes_xlsx_path, units_xlsx_path, json_output_path)
